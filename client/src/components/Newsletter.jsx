...
import {assets} from '../assets/assets'; // Adjust the path and extension as needed
...
const Newsletter =() => {
 ...
 <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
        <Title text="Subscribe to our Newsletter" subTitle="Stay updated with our latest news and offers." />
